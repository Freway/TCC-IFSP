    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseFacebookAuthentication(
               appId: "1956671181214673",
               appSecret: "69f43ce5bd274dec3b4fd2868460decc");

            app.UseGoogleAuthentication(new GoogleOAuth2AuthenticationOptions()
            {
                ClientId = "583862509236-0rbr5qeg87q7skhjn2h0ibljtf2qkb1b.apps.googleusercontent.com",
                ClientSecret = "8KnG9OKzRRaj6xFwJsOkG7d3"
            });
        }
    }
}