...
namespace Donor.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    var usuario = UserManager.FindByEmailAsync(model.Email).Result;//FindByIdAsync(User.Identity.GetUserId()).Result;
                    if ((usuario.IdPontoDeDoacao == null) && (usuario.IdUsuario == null)) {
                        return RedirectToAction("Index", "TipoContaSelecao");
                    }
                    else {
                ...
                default:
                    ModelState.AddModelError("", pt_br.AccountController_Login_Tentativa_de_login_inválida_);
                    return View(model);
            }                          
        ...
        public async Task<ActionResult> VerifyCode(VerifyCodeViewModel model)
        {
            ...
            switch (result)
            {
                ...
                case SignInStatus.LockedOut:
                    return View("Lockout");
                default:
                    ModelState.AddModelError("", pt_br.AccountController_VerifyCode_Código_inválido_);
                    return View(model);
            }
        }
        ...
        [HttpGet]
        [AllowAnonymous]
        public ActionResult EmailConfirmacao(){
            return View();
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    return RedirectToAction("EmailConfirmacao", "Account");
                }
                AddErrors(result);
            }
